...
import { ModalDiv, ErrorText, ImageText, AddData, BtnDiv, CancelBtn, CreateBtn, DataDiv, DataInput, DataLabel, ImageDiv, ImageIconSection, ImageInput, ImageSpan, ImageTitle, ImageUpload, DataTitle, ImageTitleText, ImagePreview } from "./AddModal.styled";
...
export const CategoryModal = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            let item = { id: id, image: values.image, name: values.name, slug: values.slug }
            ...
            <form onSubmit={formik.handleSubmit}>
                <ImageDiv>
                    ...
                    <ImageUpload>
                        ...
                        {formik.errors.image && <ImageText>{formik.errors.image}</ImageText>}
                    </ImageUpload>
                </ImageDiv>
                <DataDiv>
                    ...
                    <AddData>
                        ...
                        <DataInput placeholder='Soup' id="name"
                            name="name"
                            type="text"
                        ...
                        <DataInput placeholder='yummy-soup' id="slug"
                            name="slug"
                            type="text"
                            onChange={formik.handleChange}
                            value={generateSlug()}
                ...
                <BtnDiv>
                    <CancelBtn type='button' onClick={() => props.closeFunc()}>{t('cancel').charAt(0).toUpperCase() + t('cancel').slice(1)}</CancelBtn>
